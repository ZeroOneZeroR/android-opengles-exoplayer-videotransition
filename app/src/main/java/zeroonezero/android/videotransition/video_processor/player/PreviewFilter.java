...
public class PreviewFilter extends GlFilter {
    ...
    public PreviewFilter(final int texTarget) {
    ...
    public void draw(final int texName, @Nullable final float[] verticesData, final float[] mvpMatrix, final float[] stMatrix, final float aspectRatio) {
        useProgram();
        ...
        int vertexBufferName = 0;
        if(verticesData != null){
            vertexBufferName = GlUtil.createBuffer(verticesData);
